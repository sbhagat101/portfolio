  ...
  return (
    <header className="container mx-auto md:flex justify-between py-2 max-width">
      <div className="flex justify-between items-center py-2 md:py-10">
        <NavLink to="/">
          <img className="w-14" src={nav_logo} alt="logo" />
        </NavLink>
      ...
      <nav className={` ${!isOpen ? "hidden" : null} text-center md:flex justify-between`}>
        <ul className="bg-clip-text bg-gradient2 text-transparent  md:flex items-center md:space-x-5 md:mr-10 font-bold">
        ...
        <ul className="flex justify-evenly items-center my-5 md:my-0 md:space-x-5 md:mr-5">
          <li>
            <a href={"https://www.linkedin.com/in/sbhagat101/"} target="_blank" rel="noreferrer noopener">
              <svg
          ...
          <li>
            <a href={"https://github.com/sbhagat101"} target="_blank" rel="noreferrer noopener">
              <svg
                className="dark:fill-light-heading fill-dark-heading"
                width="30"
                height="30"
